...
class LieDetector(nn.Module):
    ...
    def __init__(self, input_size: int, hidden_size: int) -> None:
        ...
        self.gru = torch.nn.GRU(input_size=input_size, hidden_size=hidden_size, num_layers=1)
        ...
        self.classifier = torch.nn.Linear(in_features=hidden_size, out_features=2)
